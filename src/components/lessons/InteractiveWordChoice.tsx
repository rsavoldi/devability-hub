  ...
  return (
    <span className="inline-flex flex-wrap items-baseline gap-x-1.5 gap-y-1 mx-1 align-baseline not-prose">
      {optionsToRender.map((option, index) => {
        ...
        const isDisabled = isLessonCompleted || (isInteractionCompleted && !isCorrectSelection);
        ...
        return (
          <Button
            ...
            className={cn(
              ...
              additionalClasses,
              isDisabled && !isCorrectSelection && "cursor-not-allowed opacity-50",
              isCorrectSelection && !isLessonCompleted && "cursor-pointer",
              isCorrectSelection && isLessonCompleted && "cursor-default"
            )}
