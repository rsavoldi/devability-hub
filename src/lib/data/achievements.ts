...
import { Zap, Target, BookOpen, CheckCircle, Link2, Shuffle, MousePointerSquareDashed, Type, Trophy, Award, ListOrdered } from 'lucide-react'; // Adicionado ListOrdered
...
export const mockAchievements: Achievement[] = [
  ...
  { id: 'ach6', title: 'Organizador Nato', description: 'Completou um exercício de ordenação.', emoji: '🔢', icon: ListOrdered, isUnlocked: false, criteria: '1 exercício ordenação' },
